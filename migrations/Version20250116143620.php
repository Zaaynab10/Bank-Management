 ...
 */
<<<<<<<< HEAD:migrations/Version20250117161747.php
final class Version20250117161747 extends AbstractMigration
========
final class Version20250116143620 extends AbstractMigration
>>>>>>>> e97728da3847fdedb6e0a3e193a2ee3173b6a664:migrations/Version20250116143620.php
{
...
<<<<<<<< HEAD:migrations/Version20250117161747.php
        $this->addSql('CREATE TABLE bank_account (id SERIAL NOT NULL, owner_id INT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
========
        $this->addSql('CREATE TABLE bank_account (id SERIAL NOT NULL, owner_id INT NOT NULL, account_number VARCHAR(255) NOT NULL, balance DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
...
<<<<<<<< HEAD:migrations/Version20250117161747.php
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, phone VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
========
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, phone VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
>>>>>>>> e97728da3847fdedb6e0a3e193a2ee3173b6a664:migrations/Version20250116143620.php
